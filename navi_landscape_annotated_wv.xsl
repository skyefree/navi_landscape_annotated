...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">Navi_landscape.jpg</xsl:variable>
    <xsl:variable name="DocFileName">navi_landscape_annotated</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">438</xsl:variable>
    <xsl:variable name="ZoomImageWidth">2560</xsl:variable>
    <xsl:variable name="ZoomImageHeight">1400</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.3125</xsl:variable>
    <xsl:variable name="ScaledImageFileName">navi_landscape_annotated_wv_Navi_landscape.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">navi_landscape_annotated_wv_zoom_Navi_landscape.jpg</xsl:variable>
